...
class BibleVersesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bible_verse" do
    assert_difference('BibleVerse.count') do
      post bible_verses_url, params: { bible_verse: { verse_num: @bible_verse.verse_num, verse_text: @bible_verse.verse_text } }
    end
  ...
  test "should update bible_verse" do
    patch bible_verse_url(@bible_verse), params: { bible_verse: { verse_num: @bible_verse.verse_num, verse_text: @bible_verse.verse_text } }
